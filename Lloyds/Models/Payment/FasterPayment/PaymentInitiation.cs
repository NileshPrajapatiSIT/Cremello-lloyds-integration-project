...
/// <summary>Requests movement of funds from the debtor account to a creditor for a single Faster Payment. Maps to PaymentInitiation in bilateral-faster-payment-channel-api-v4.0.0.yaml.</summary>
public class PaymentInitiation
{
    ...
    public FasterPaymentDebtorAccount DebtorAccount { get; set; } = new();
    ...
    /// <summary>True = immediate SIP; false/omitted = FDP for today or the requestedExecutionDate.</summary>
    [JsonPropertyName("urgencyFlag")]
    public bool? UrgencyFlag { get; set; }
}
